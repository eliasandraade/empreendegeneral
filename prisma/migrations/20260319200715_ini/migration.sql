...
-- CreateEnum
CREATE TYPE "ReportReason" AS ENUM ('INAPPROPRIATE_CONTENT', 'WRONG_INFORMATION', 'SPAM', 'DUPLICATE', 'OTHER');
...
-- AddForeignKey
ALTER TABLE "Highlight" ADD CONSTRAINT "Highlight_businessId_fkey" FOREIGN KEY ("businessId") REFERENCES "Business"("id") ON DELETE CASCADE ON UPDATE CASCADE;
